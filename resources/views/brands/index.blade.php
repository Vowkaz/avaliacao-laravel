            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-xl">Marcas Cadastrados</h3>
                    ...
                    <table class="min-w-full table-auto">
                        ...
                        @foreach ($brands as $brand)
                            <tr>
                                <td class="px-2 py-2 border-b">{{ $brand->name }}</td>
                                <td class="py-2 border-b">{{ $brand->created_at->format('d/m/Y') }}</td>
                                @can('gestao-marcas')
    ...
    <aside x-data="{ open: false }" x-show="open" @open-aside.window="open = true"
        ...
        <div class=" rounded-lg shadow-lg mx-auto" style="width: 28rem">
            <div class="bg-white w-full dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between items-center mb-4">
                        <h2 class="text-xl font-semibold">Cadastrar Marca</h2>
    ...
    >
        <div class="rounded-lg shadow-lg mx-auto" style="width: 28rem">
            <div class="bg-white w-full dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between items-center mb-4">
                        <h2 class="text-xl font-semibold">Editar Marca</h2>
                    ...
                    <form x-data :action="'{{ route('brands.update', '') }}' + '/' + id" method="POST">
                        @csrf
                        <div class="mb-4">
                            <label for="name" class="block">Nome</label>
