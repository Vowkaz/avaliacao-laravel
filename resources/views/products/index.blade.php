            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-xl">Produtos Cadastrados</h3>
                    ...
                    <table class="min-w-full table-auto">
                        ...
                        @foreach ($products as $product)
                            <tr>
                                ...
                                <td class="py-2 border-b">{{ $product->created_at->format('d/m/Y') }}</td>
                                @can('gestao-produtos')
        ...
        <div class="rounded-lg shadow-lg mx-auto" style="width: 28rem">
            <div class="bg-white w-full dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form x-data :action="'{{ route('products.update', '') }}' + '/' + id" method="POST">
                        @csrf
                        <div class="mb-4">
                            <label for="name" class="block">Nome</label>
